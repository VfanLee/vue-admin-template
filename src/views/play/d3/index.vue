...
<script setup lang="ts">
  // import Svg1 from './components/svg-1.vue'
  import D3Bar from './components/d3-bar.vue'
  import D3Axis from './components/d3-axis.vue'
  import D3Force from './components/d3-force.vue'

  // Demo列表配置
  const demoList = shallowRef([
    // { id: 'svg-1', title: 'SVG 1', component: Svg1 },
    { id: 'd3-bar', title: 'D3 Bar', component: D3Bar },
    { id: 'd3-axis', title: 'D3 Axis', component: D3Axis },
    { id: 'd3-force', title: 'D3 Force', component: D3Force },
  ])

  const contentAreaRef = ref<HTMLElement | null>(null)
  const activeDemo = ref('d3-bar')
